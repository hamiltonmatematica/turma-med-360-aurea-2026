      ...
      <div className="container mx-auto max-w-5xl px-6 relative z-10">
        ...
        >
          ...
          <div className="p-8 md:p-20 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 mb-12 bg-gray-50 p-8 rounded-3xl border border-gray-100">
              <div className="text-center">
                <span className="block text-gray-400 text-sm uppercase font-bold mb-2 tracking-wider">Preço à vista</span>
                <span className="text-5xl md:text-6xl font-display text-aurea-blue">R$ 8.400</span>
                <span className="text-2xl font-brand font-bold text-aurea-blue">,00</span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
              <Button href={ctaLink} variant="primary" className="min-w-[240px] text-lg py-5 shadow-aurea-orange/30 shadow-xl">
                Quero à vista
              </Button>
              <Button href={ctaLink} variant="outline" className="min-w-[240px] text-lg py-5">
                Quero parcelado
              </Button>
            </div>
